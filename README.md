...
- build.bat          â€” docker-compose build
- up.bat             â€” docker-compose up --build
- down.bat           â€” docker-compose down --volumes --remove-orphans
- test.bat           â€” create venv, install deps, run pytest (backend)
- frontend-build.bat â€” install frontend deps and build
- backend-build.bat  â€” build backend Docker image
- release.bat        â€” build & optionally tag/push images (pass VERSION and optional REGISTRY as arguments)
